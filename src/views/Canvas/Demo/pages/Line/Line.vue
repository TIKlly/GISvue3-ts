...
const createCanvasAnimation = () => {
    ...
    const createGradient = () => {
        ...
        gradient.addColorStop(0, `rgba(${randomNum(0, 255)}, ${randomNum(0, 255)}, ${randomNum(0, 255)}, 1)`);
        gradient.addColorStop(1, `rgba(${randomNum(0, 255)}, ${randomNum(0, 255)}, ${randomNum(0, 255)}, 1)`);
        return gradient;
    };
    ...
    for (let i = 0; i < lineCount; i++) {
        ...
        lines.push(new LineClass(x, y, length, speed, directionX, directionY, color));
    }
