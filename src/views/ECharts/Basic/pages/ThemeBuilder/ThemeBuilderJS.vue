...
<template>
    ...
    <aside>
        ...
        <p>
            1. 在
            <el-link href="https://echarts.apache.org/zh/theme-builder.html" target="_blank" type="primary">
...
onMounted(() => {
    store.setComponentPath('src/views/ECharts/Basic/pages/ThemeBuilder/ThemeBuilderJS.vue')
    chartInit()
})
