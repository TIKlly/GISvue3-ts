      ...
      <el-card shadow="hover">
        ...
        <template #default>
          <div class="chart__wrapper">
            <el-row :gutter="20">
              <el-col :span="12">
                <ChartDom class="keyword__chart__x" :options="searchUsersNum.options" />
              </el-col>
              <el-col :span="12">
                <ChartDom class="keyword__chart__x" :options="searchVolume.options" />
              </el-col>
            </el-row>
            <div class="table__wrapper">
              <el-table :data="tableData">
                <el-table-column prop="rank" label="排名"></el-table-column>
                <el-table-column prop="keyWrod" label="关键字"></el-table-column>
                <el-table-column prop="count" label="总搜索量"></el-table-column>
                <el-table-column prop="users" label="搜索用户数"></el-table-column>
              </el-table>
              <el-pagination layout="prev, pager, next" :total="50" :page-size="4" background class="pagination"
          ...
          <div class="title__wrapper">
            ...
            <div class="radio__wrapper">
              <el-radio-group v-model="salesInfo.radioSelect" size="small">
                <el-radio-button v-for="btnName in salesInfo.radioTypes" :key="btnName"
