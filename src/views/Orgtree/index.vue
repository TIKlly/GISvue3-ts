<template>
  <div>
    <div style="display: flex; padding: 10px">
      ...
      <div style="margin-right: 10px">
        <el-switch v-model="collapsable"></el-switch> 可收起
      </div>
      <div style="margin-right: 10px">
        <el-switch v-model="disaled"></el-switch> 禁止编辑
      </div>
      <div style="margin-right: 10px">
        <el-switch v-model="onlyOneNode"></el-switch> 仅拖动当前节点
      </div>
      <div style="margin-right: 10px">
        <el-switch v-model="cloneNodeDrag"></el-switch> 拖动节点副本
      </div>
    </div>
          ...
          },
          {
            ...
            children: [
              ...
              { id: 12, pid: 3, label: "客服二部" },
              {
                ...
                label: "客服三部",
                children: [
                  { id: 14, pid: 4, label: "禁止编辑节点", disabled: true },
                  { id: 15, pid: 4, label: "禁止拖拽节点", noDragging: true },
                  { id: 16, pid: 4, label: "测试" },
                ],
              },
            ],
          },
